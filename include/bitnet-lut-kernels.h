...
#define BM5120_5120 256
#define BBK5120_5120 96
template<int batch_size, int K3>
inline void three_tbl_impl_5120_5120(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    ...
    const int KK = BBK5120_5120 / 3;
#pragma unroll
        for (int i = 0; i < BM5120_5120; i += 32) {
        __m256i vec_as[KK / 2];
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM5120_5120 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM5120_5120 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM5120_5120 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM5120_5120 * bs));
        ...
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM5120_5120 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM5120_5120 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM5120_5120 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM5120_5120 * bs), vec_gc3);
    }
    }
#endif
}
...
inline int32_t two_tbl_impl5120_5120(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
int32_t three_qgemm_lut_5120_5120(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM5120_5120];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM5120_5120 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 5088 / BBK5120_5120; ++k_outer) {
        three_tbl_impl_5120_5120<BATCH_SIZE, 5088>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK5120_5120 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK5120_5120 / 3 / 2 * BM5120_5120)])), (&(((uint8_t*)sign)[(k_outer * BBK5120_5120 / 3 / 8 * BM5120_5120)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM5120_5120; i++) {
            ((int32_t*)C)[bs * out_stride + i] = (int32_t)(((int32_t*)CBits)[i + bs * BM5120_5120]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_5120_5120(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM5120_5120];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM5120_5120 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 32 / 32; ++k_outer) {
        two_tbl_impl5120_5120<BATCH_SIZE, 32>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM5120_5120)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM1024_5120 128
#define BBK1024_5120 96
template<int batch_size, int K3>
inline void three_tbl_impl_1024_5120(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK1024_5120 / 3;
#pragma unroll
        for (int i = 0; i < BM1024_5120; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM1024_5120 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM1024_5120 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM1024_5120 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM1024_5120 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM1024_5120 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM1024_5120 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM1024_5120 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM1024_5120 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl1024_5120(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_1024_5120(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM1024_5120];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM1024_5120 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 5088 / BBK1024_5120; ++k_outer) {
        three_tbl_impl_1024_5120<BATCH_SIZE, 5088>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK1024_5120 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK1024_5120 / 3 / 2 * BM1024_5120)])), (&(((uint8_t*)sign)[(k_outer * BBK1024_5120 / 3 / 8 * BM1024_5120)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM1024_5120; i++) {
            ((int32_t*)C)[bs * out_stride + i] = (int32_t)(((int32_t*)CBits)[i + bs * BM1024_5120]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_1024_5120(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM1024_5120];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM1024_5120 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 32 / 32; ++k_outer) {
        two_tbl_impl1024_5120<BATCH_SIZE, 32>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM1024_5120)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM27648_5120 256
#define BBK27648_5120 96
template<int batch_size, int K3>
inline void three_tbl_impl_27648_5120(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK27648_5120 / 3;
#pragma unroll
        for (int i = 0; i < BM27648_5120; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM27648_5120 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM27648_5120 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM27648_5120 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM27648_5120 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM27648_5120 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM27648_5120 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM27648_5120 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM27648_5120 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl27648_5120(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_27648_5120(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM27648_5120];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM27648_5120 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 5088 / BBK27648_5120; ++k_outer) {
        three_tbl_impl_27648_5120<BATCH_SIZE, 5088>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK27648_5120 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK27648_5120 / 3 / 2 * BM27648_5120)])), (&(((uint8_t*)sign)[(k_outer * BBK27648_5120 / 3 / 8 * BM27648_5120)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM27648_5120; i++) {
            ((int32_t*)C)[bs * out_stride + i] = (int32_t)(((int32_t*)CBits)[i + bs * BM27648_5120]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_27648_5120(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM27648_5120];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM27648_5120 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 32 / 32; ++k_outer) {
        two_tbl_impl27648_5120<BATCH_SIZE, 32>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM27648_5120)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
#define BM5120_27648 256
#define BBK5120_27648 96
template<int batch_size, int K3>
inline void three_tbl_impl_5120_27648(int32_t* c, int8_t* lut, uint8_t* a, uint8_t* sign) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const __m256i vec_sign_mask  = _mm256_set1_epi16(0x8000);
    const __m256i vec_zero  = _mm256_set1_epi8(0x00);
    const __m256i vec_one  = _mm256_set1_epi8(0xff);
    const int KK = BBK5120_27648 / 3;
#pragma unroll
        for (int i = 0; i < BM5120_27648; i += 32) {
        __m256i vec_as[KK / 2];
        __m256i vec_signs[KK / 8];
        #pragma unroll
        for (int ai = 0; ai < KK / 2; ai++) {
...
#pragma unroll
        ...
        __m256i vec_gc0 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i      + BM5120_27648 * bs));
        __m256i vec_gc1 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM5120_27648 * bs));
        __m256i vec_gc2 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM5120_27648 * bs));
        __m256i vec_gc3 = _mm256_loadu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM5120_27648 * bs));
        vec_gc0 = _mm256_add_epi32(vec_gc0, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c0)));
        vec_gc1 = _mm256_add_epi32(vec_gc1, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c0, 1)));
        vec_gc2 = _mm256_add_epi32(vec_gc2, _mm256_cvtepi16_epi32(_mm256_castsi256_si128(vec_c1)));
        vec_gc3 = _mm256_add_epi32(vec_gc3, _mm256_cvtepi16_epi32(_mm256_extracti128_si256(vec_c1, 1)));
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i      + BM5120_27648 * bs), vec_gc0);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 8  + BM5120_27648 * bs), vec_gc1);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 16 + BM5120_27648 * bs), vec_gc2);
        _mm256_storeu_si256(reinterpret_cast<__m256i*>(c + i + 24 + BM5120_27648 * bs), vec_gc3);
    }
    }
#endif
}
...
template<int batch_size, int K2>
inline int32_t two_tbl_impl5120_27648(int32_t* c, int8_t* lut, uint8_t* a) {
#ifdef __AVX2__
    const __m256i vec_mask = _mm256_set1_epi8(0x0f);
    const int KK = BK2 / 2;
#pragma unroll
...
template<int BATCH_SIZE>
int32_t three_qgemm_lut_5120_27648(void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM5120_27648];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM5120_27648 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 27648 / BBK5120_27648; ++k_outer) {
        three_tbl_impl_5120_27648<BATCH_SIZE, 27648>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BBK5120_27648 / 3 * 32)])), (&(((uint8_t*)A)[(k_outer * BBK5120_27648 / 3 / 2 * BM5120_27648)])), (&(((uint8_t*)sign)[(k_outer * BBK5120_27648 / 3 / 8 * BM5120_27648)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
        for (int i = 0; i < BM5120_27648; i++) {
            ((int32_t*)C)[bs * out_stride + i] = (int32_t)(((int32_t*)CBits)[i + bs * BM5120_27648]);
        }
  }
  return 0;
}
...
template<int BATCH_SIZE>
int32_t two_qgemm_lut_5120_27648(void* A, void* LUT, void* Scales, void* LUT_Scales, void* C, int out_stride) {
    alignas(32) uint32_t CBits[BATCH_SIZE * BM5120_27648];
    memset(&(CBits[0]), 0, BATCH_SIZE * BM5120_27648 * sizeof(int32_t));
#pragma unroll
    for (int32_t k_outer = 0; k_outer < 0 / 32; ++k_outer) {
        two_tbl_impl5120_27648<BATCH_SIZE, 0>((&(((int32_t*)CBits)[0])), (&(((int8_t*)LUT)[(k_outer * BK2 / 2 * 32)])), (&(((uint8_t*)A)[(k_outer * BK2 / 2 / 2 * BM5120_27648)])));
    }
#pragma unroll
    for (int bs = 0; bs < BATCH_SIZE; bs++) {
#pragma unroll
...
void ggml_preprocessor(int bs, int m, int three_k, int two_k, void* B, void* LUT_Scales, void* Three_QLUT, void* Two_QLUT) {
    ...
    if (m == 5120 && two_k == 32 && three_k == 5088) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<5088>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<32>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 5088])), (&(((float*)LUT_Scales)[b])));
        }
    }
    else if (m == 1024 && two_k == 32 && three_k == 5088) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<5088>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<32>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 5088])), (&(((float*)LUT_Scales)[b])));
    ...
    else if (m == 27648 && two_k == 32 && three_k == 5088) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<5088>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<32>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 5088])), (&(((float*)LUT_Scales)[b])));
    ...
    else if (m == 5120 && two_k == 0 && three_k == 27648) {
        for (int32_t b = 0; b < bs; b++) {
            per_tensor_quant(two_k + three_k, (&(((float*)LUT_Scales)[b])), (&(((float*)B)[b * (two_k + three_k)])));
            three_lut_ctor<27648>((&(((int8_t*)Three_QLUT)[b * three_k / 3 * 32])), (&(((float*)B)[b * (three_k + two_k)])), (&(((float*)LUT_Scales)[b])));
            two_lut_ctor<0>((&(((int8_t*)Two_QLUT)[b * two_k / 2 * 32])), (&(((float*)B)[b * (three_k + two_k) + 27648])), (&(((float*)LUT_Scales)[b])));
        }
    }
}
void ggml_qgemm_lut(int bs, int m, int k, int BK, void* A, void* sign, void* LUT, void* Scales, void* LUT_Scales, void* C) {
    if (m == 5120 && k == 5120) {
        if (BK == 32) {
            if (bs == 1) {
                two_qgemm_lut_5120_5120<1>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 8) {
                two_qgemm_lut_5120_5120<8>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 32) {
                two_qgemm_lut_5120_5120<32>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 128) {
                two_qgemm_lut_5120_5120<128>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 256) {
                two_qgemm_lut_5120_5120<256>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 512) {
                two_qgemm_lut_5120_5120<512>(A, LUT, Scales, LUT_Scales, C, m);
            }
        }
        else if (BK == 5088) {
            if (bs == 1) {
                three_qgemm_lut_5120_5120<1>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 8) {
                three_qgemm_lut_5120_5120<8>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 32) {
                three_qgemm_lut_5120_5120<32>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 128) {
                three_qgemm_lut_5120_5120<128>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 256) {
                three_qgemm_lut_5120_5120<256>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 512) {
                three_qgemm_lut_5120_5120<512>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }
        }
    }
    else if (m == 1024 && k == 5120) {
        if (BK == 32) {
            if (bs == 1) {
                two_qgemm_lut_1024_5120<1>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 8) {
                two_qgemm_lut_1024_5120<8>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 32) {
                two_qgemm_lut_1024_5120<32>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 128) {
                two_qgemm_lut_1024_5120<128>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 256) {
                two_qgemm_lut_1024_5120<256>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 512) {
                two_qgemm_lut_1024_5120<512>(A, LUT, Scales, LUT_Scales, C, m);
            }
        }
        else if (BK == 5088) {
            if (bs == 1) {
                three_qgemm_lut_1024_5120<1>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 8) {
                three_qgemm_lut_1024_5120<8>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 32) {
                three_qgemm_lut_1024_5120<32>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 128) {
                three_qgemm_lut_1024_5120<128>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 256) {
                three_qgemm_lut_1024_5120<256>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 512) {
                three_qgemm_lut_1024_5120<512>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }
        }
    }
    else if (m == 27648 && k == 5120) {
        if (BK == 32) {
            if (bs == 1) {
                two_qgemm_lut_27648_5120<1>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 8) {
                two_qgemm_lut_27648_5120<8>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 32) {
                two_qgemm_lut_27648_5120<32>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 128) {
                two_qgemm_lut_27648_5120<128>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 256) {
                two_qgemm_lut_27648_5120<256>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 512) {
                two_qgemm_lut_27648_5120<512>(A, LUT, Scales, LUT_Scales, C, m);
            }
        }
        else if (BK == 5088) {
            if (bs == 1) {
                three_qgemm_lut_27648_5120<1>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 8) {
                three_qgemm_lut_27648_5120<8>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 32) {
                three_qgemm_lut_27648_5120<32>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 128) {
                three_qgemm_lut_27648_5120<128>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 256) {
                three_qgemm_lut_27648_5120<256>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 512) {
                three_qgemm_lut_27648_5120<512>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }
        }
    }
    else if (m == 5120 && k == 27648) {
        if (BK == 0) {
            if (bs == 1) {
                two_qgemm_lut_5120_27648<1>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 8) {
                two_qgemm_lut_5120_27648<8>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 32) {
                two_qgemm_lut_5120_27648<32>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 128) {
                two_qgemm_lut_5120_27648<128>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 256) {
                two_qgemm_lut_5120_27648<256>(A, LUT, Scales, LUT_Scales, C, m);
            } else if (bs == 512) {
                two_qgemm_lut_5120_27648<512>(A, LUT, Scales, LUT_Scales, C, m);
            }
        }
        else if (BK == 27648) {
            if (bs == 1) {
                three_qgemm_lut_5120_27648<1>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 8) {
                three_qgemm_lut_5120_27648<8>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 32) {
                three_qgemm_lut_5120_27648<32>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 128) {
                three_qgemm_lut_5120_27648<128>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 256) {
                three_qgemm_lut_5120_27648<256>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }else if (bs == 512) {
                three_qgemm_lut_5120_27648<512>(A, sign, LUT, Scales, LUT_Scales, C, m);
            }
        }
    }
}
