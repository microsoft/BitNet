...
class Attention(nn.Module):
	...
	def forward(
		...
		xq = xq.view(1, xq.shape[0], self.n_local_kv_heads, heads_per_group, self.head_dim)
		...
		output = fmha.memory_efficient_attention_forward(xq, cache_k, cache_v, attn_bias, op=fmha.flash.FwOp)
