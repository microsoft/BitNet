"""Falcon 3B fine-tune — versão exec() para Colab (sem %run).

USO NO COLAB (cole em UMA célula, sem indentação):
    exec(open('/content/BitNet/bitnet-studio/colab_f3b_exec.py').read())
...
# Tokenizer (sem tokenizers library)
