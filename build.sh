...
EMCC_FLAGS="-O3 -msimd128 -fno-rtti -DNDEBUG -flto=full -s WASM=1 -s MODULARIZE=1 -s EXPORT_ES6=1 -s EXPORT_ALL=1 -s EXPORTED_RUNTIME_METHODS=['ccall','cwrap'] -s ALLOW_MEMORY_GROWTH=1 -s INITIAL_MEMORY=1GB -s MAXIMUM_MEMORY=4GB -s FORCE_FILESYSTEM=1 -s NO_EXIT_RUNTIME=1"
