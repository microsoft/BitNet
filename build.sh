...
EMCC_FLAGS="-O3 -s WASM=1 -s MODULARIZE=1 -s EXPORT_ES6=1 -s EXPORTED_RUNTIME_METHODS=['ccall','cwrap'] -s EXPORTED_FUNCTIONS=['_ggml_init','_ggml_nelements','_ggml_bitnet_init','_ggml_bitnet_free'] -s ALLOW_MEMORY_GROWTH=1 -DGGML_BITNET_ARM_TL1"
