...
# Fake model generation script based on convert-hf-to-gguf-bitnet.py
...
import torch
import gguf
logger = logging.getLogger("generate-fake-bitnet-model")
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Generate a fake bitnet model with GGUF format")
    parser.add_argument(
