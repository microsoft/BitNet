...
class EmbeddingQuantizer:
    ...
    def quantize(self, embedding_type, output_suffix):
        ...
        if file_already_existed:
            ...
            print("   Skipping quantization, will use existing file for benchmark")
            return True
    ...
    def benchmark_model(self, output_suffix):
        ...
        try:
            ...
            print("❌ Benchmark timeout (exceeded 5 minutes)")
            return None
    ...
    def run_all_quantizations(self, types_to_quantize):
        ...
        """
        print(f"\n{'='*80}")
        print("🚀 Starting Embedding Quantization and Benchmarking")
        print(f"{'='*80}")
    ...
    def save_results_to_csv(self):
        ...
        if self.csv_output:
            ...
            csv_file = self.stats_dir / "embedding_benchmark.csv"
    ...
    def print_summary(self, total_duration):
        ...
        print(f"\n\n{'='*80}")
        print("📊 QUANTIZATION AND BENCHMARK SUMMARY")
        print(f"{'='*80}\n")
